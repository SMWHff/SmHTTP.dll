...
dp.sh.Toolbar.Commands = {
	...
	CopyToClipboard: {
		label: '\u590d\u5236\u4ee3\u7801',
		check: function() {
			return window.clipboardData != null || document.execCommand != null;
		},
		func: function(sender, highlighter) {
...
dp.sh.HighlightAll = function(name, showGutter, showControls, collapseAll, firstLine, showColumns) {
	...
	for (var i = 0; i < elements.length; i++) {
		...
		var options = FindValue(element.attributes['class'], element.className, element.attributes['language'],
			element.language);
		var language = '';
		if (options == null)
			continue;
